            ...
            <section class="agenda-panel">
                <div class="panel-top">
                    <div>
                        ...
                        <p>Gerencie os projetos existentes.</p>
                    </div>
                </div>
                        ...
                        <tbody>
                            @forelse($projeto as $p)
                                <tr>
                                    ...
                                    <td>{{ $p->descricao }}</td>
                                    <td>
                                        <span class="status-badge {{ strtolower($p->quantiaTarefas) == 0 ? 'status-pendente' : 'status-concluida' }}">
                                            {{ $p->quantiaTarefas}}
                                        </span>
                                    </td>
                                ...
                                <div class="modal fade" id="modalEditar{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal fade" id="modalexcluir{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
